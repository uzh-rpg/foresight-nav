"""
This file is originally from the RoomFormer project:
https://github.com/ywyue/RoomFormer/tree/main/data_preprocess/stru3d

Original Author(s): Yuanwen Yue et al.
...
from datagen_imagination.occupancy_generation.common_utils import resort_corners
